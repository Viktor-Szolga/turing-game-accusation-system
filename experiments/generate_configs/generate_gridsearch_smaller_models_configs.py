...
# Output folder
out_dir = Path(os.path.join("experiments", "runs", "gridsearch_smaller_models", "experiments"))
out_dir.mkdir(exist_ok=True, parents=True)

# Verzeichnis file (index)
verzeichnis_file = Path("experiments/runs/gridsearch_smaller_models/runs.txt")
verzeichnis_lines = []
