...
# Output folder
out_dir = Path(os.path.join("experiments", "runs", "early_stopping_fixed_epoch_bow", "experiments"))
...
verzeichnis_file = Path(os.path.join("experiments", "runs", "early_stopping_fixed_epoch_bow", "runs.txt"))
verzeichnis_lines = []
