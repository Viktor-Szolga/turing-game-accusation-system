...
from src.models import TemperatureScaledEnsemble, EnsembleMessageClassifier
from sklearn.metrics import brier_score_loss
from omegaconf import OmegaConf
import src.utils as utils

N_BINS = 10
root_dir = "temperature_scaling_ensemble"
...
for run_name, label in zip(run_names, labels):
    ...
    scaled_model = TemperatureScaledEnsemble(model).to(config.device)
